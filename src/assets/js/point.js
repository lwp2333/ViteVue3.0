  ...
  function c(e) {
    ...
    function c() {
      L(T),
        ...
        e.running &&
          !j &&
          ((e.dt = (B = +new Date()) - e.now), (e.millis += e.dt), (e.now = B), n(e.update), e.autoclear && K && e.clear(), n(e.draw)),
        (j = ++j % e.interval)
    }
    function l() {
    ...
    function h(t) {
      for (
        t = g(t), q = (Q = J.indexOf((z = t.type))) - 1, e.dragging = /down|start/.test(z) ? !0 : /up|end/.test(z) ? !1 : e.dragging;
        q;
...
if (document.getElementById('clickCanvas')) {
  ...
  clickparticle.spawn = function (x, y) {
    ...
    particle.init(x, y, random(4, 12)) //圆点大小范围
